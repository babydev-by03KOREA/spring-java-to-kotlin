...
class BookServiceTest @Autowired constructor(
    ...
    fun saveBookTest() {
        // given
        val request = BookRequest("처음 시작하는 FastAPI")
    ...
    fun loanBookTest() {
        // given
        bookRepository.save(Book("처음 시작하는 FastAPI"))
    ...
    fun loanBookFailTest() {
        ...
        bookRepository.save(Book("처음 시작하는 FastAPI"))
        val savedUser = userRepository.save(User("박형주", 22))
        userLoanHistoryRepository.save(UserLoanHistory(savedUser, "처음 시작하는 FastAPI", false))
        val request = BookLoanRequest("박형주", "처음 시작하는 FastAPI")
